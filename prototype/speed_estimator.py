...
class SpeedEstimator:
    ...
    def estimate_speed(self, im0, tracks, region_color=(255, 0, 0), return_speed=False):
        """
        ...
        Args:
            ...
            return_speed (bool, optional): Whether to return speed data. Defaults to False.

        Returns:
            (ndarray): The image with annotated boxes and tracks.
            (list, optional): List of (track_id, speed) tuples if return_speed is True.
        """
        self.im0 = im0
        speeds = []
        ...
        if tracks[0].boxes.id is None:
            if self.view_img and self.env_check:
                self.display_frames()
            return (im0, speeds) if return_speed else im0
        ...
        for box, trk_id, cls in zip(self.boxes, self.trk_ids, self.clss):
            ...
            if trk_id in self.dist_data:
                speeds.append((trk_id, self.dist_data[trk_id]))
